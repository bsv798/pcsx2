...
extern void StateCopy_LoadFromSlot( uint slot, bool isFromBackup, bool resume );
...
extern void States_DefrostCurrentSlotBackupPause();
extern void States_DefrostCurrentSlotPause();
